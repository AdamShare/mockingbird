...
public extension ValueProvider {
  ...
  /// https://developer.apple.com/documentation/foundation/numbers_data_and_basic_values
    nonisolated(unsafe) static let primitivesProvider = ValueProvider(values: [
...
#if canImport(CoreGraphics)
nonisolated(unsafe) private let basicsProviderCGValues = [
...
public extension ValueProvider {
  ...
  ///
  /// https://developer.apple.com/documentation/foundation/numbers_data_and_basic_values
    nonisolated(unsafe) static let basicsProvider = ValueProvider(
    values: [
...
#if canImport(ObjectiveC)
nonisolated(unsafe) private let stringsProviderNSValues = [
...
public extension ValueProvider {
  ...
  /// https://developer.apple.com/documentation/foundation/strings_and_text
    nonisolated(unsafe) static let stringsProvider = ValueProvider(values: [
...
#if canImport(ObjectiveC)
nonisolated(unsafe) private let datesProviderNSValues = [
...
public extension ValueProvider {
  ...
  /// https://developer.apple.com/documentation/foundation/dates_and_times
    nonisolated(unsafe) static let datesProvider = ValueProvider(values: [
